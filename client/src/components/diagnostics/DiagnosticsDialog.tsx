...
function RuntimeTable<T extends RuntimeItem>({
  ...
  return (
    <ScrollArea h={470} type="auto" offsetScrollbars>
      ...
      <Stack gap="md" h="min(640px, calc(100vh - 130px))">
        ...
        <Tabs defaultValue="sensors" style={{ flex: 1, minHeight: 0 }}>
          <Tabs.List>
            ...
            <Tabs.Tab value="turnouts">Turnouts</Tabs.Tab>
            <Tabs.Tab value="accessories">Basic accessories</Tabs.Tab>
          </Tabs.List>

          <Tabs.Panel value="sensors" pt="md">
            <RuntimeTable
              items={sensors}
              emptyText="No sensor runtime data yet."
              stateLabel="State"
          ...
          <Tabs.Panel value="turnouts" pt="md">
            <RuntimeTable
              items={turnouts}
              emptyText="No turnout runtime data yet."
              stateLabel="State"
