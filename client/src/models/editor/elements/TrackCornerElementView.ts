...
export class TrackCornerElementView extends TrackElement implements ITrackCornerElement {
    ...
    static fromJSON(data: ITrackCornerElement): TrackCornerElementView {
        const corner = new TrackCornerElementView(data.x, data.y);
        corner.id = data.id;
    ...
    override clone(): TrackCornerElementView {
        const copy = new TrackCornerElementView(this.x, this.y);
        copy.id = generateId();
