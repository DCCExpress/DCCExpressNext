...
export class TrackTurnoutTwoWayElementView extends TrackElement implements ITrackTurnoutTwoWayElement {
    ...
    static fromJSON(data: ITrackTurnoutTwoWayElement) : TrackTurnoutTwoWayElementView {
        const e = new TrackTurnoutTwoWayElementView(data.x, data.y);
        e.id = data.id;
        e.name = data.name;
    ...
    override clone(): TrackTurnoutTwoWayElementView {
        const copy = new TrackTurnoutTwoWayElementView(this.x, this.y);
        copy.id = generateId();
