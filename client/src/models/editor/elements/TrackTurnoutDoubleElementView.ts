...
export default class TrackTurnoutDoubleElementView extends TrackElement {
    ...
    static fromJSON(data: ITrackTurnoutDoubleElement) : TrackTurnoutDoubleElementView {
        const e = new TrackTurnoutDoubleElementView(data.x, data.y);
        e.id = data.id;
        e.name = data.name;
    ...
    override clone(): TrackTurnoutDoubleElementView {
        const copy = new TrackTurnoutDoubleElementView(this.x, this.y);
        copy.id = generateId();
