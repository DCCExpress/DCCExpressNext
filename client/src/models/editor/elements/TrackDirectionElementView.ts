...
export class TrackDirectionElementView
   ...
   draw(ctx: CanvasRenderingContext2D, options?: DrawOptions): void {
    ...
    /**
     * A TrackDirectionElementView "előre" irányába eső
     * szomszédos rácspont.
     *
     * Fontos:
    ...
    /**
     * A TrackDirectionElementView "hátra" irányába eső
     * szomszédos rácspont.
     */
    ...
    static fromJSON(
        ...
        const track = new TrackDirectionElementView(data.x, data.y);
    ...
    override clone(): TrackDirectionElementView {
        const copy = new TrackDirectionElementView(this.x, this.y);
