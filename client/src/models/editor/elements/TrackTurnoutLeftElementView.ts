...
import { ITrackTurnoutLeftElement } from "../types/EditorTypes";
import { TrackTurnoutElement } from "./TrackTurnoutElement";

export class TrackTurnoutLeftElementView extends TrackTurnoutElement implements ITrackTurnoutLeftElement {
    ...
    static formJSON(data: ITrackTurnoutLeftElement): TrackTurnoutLeftElementView {
        const e = new TrackTurnoutLeftElementView(data.x, data.y);
        e.id = data.id;
        e.name = data.name;
    ...
    override clone(): TrackTurnoutLeftElementView {
        const copy = new TrackTurnoutLeftElementView(this.x, this.y);
        copy.id = generateId();
